...
<%@ page import="com.example.lab10_grupodinamin.Beans.Location" %>
<%@page contentType="text/html" pageEncoding="UTF-8" %>
<jsp:useBean id="listaLocations" scope="request" type="java.util.ArrayList<com.example.lab10_grupodinamin.Beans.Location>"/>
<jsp:useBean id="listaEmpleados" scope="request" type="java.util.ArrayList<com.example.lab10_grupodinamin.Beans.Employee>"/>
<jsp:useBean id="department" scope="request" type="com.example.lab10_grupodinamin.Beans.Department"/>
<!DOCTYPE html>
<html>
    <head>
