<%@ page import="com.example.lab10_grupodinamin.Beans.Country" %>
<%@page contentType="text/html" pageEncoding="UTF-8" %>
<jsp:useBean id="listaPaises" scope="request" type="java.util.ArrayList<com.example.lab10_grupodinamin.Beans.Country>"/>
<jsp:useBean id="location" scope="request" type="com.example.lab10_grupodinamin.Beans.Location"/>
<!DOCTYPE html>
<html>
    <head>
