<%@page import="com.example.lab10_grupodinamin.Dtos.SalarioPorDepartamentoDto" %>
<%@page import="com.example.lab10_grupodinamin.Dtos.EmpleadosPorRegionDto" %>
<%@page contentType="text/html" pageEncoding="UTF-8" %>
<jsp:useBean id="listaEmpleadPorRegion" type="java.util.ArrayList<com.example.lab10_grupodinamin.Dtos.EmpleadosPorRegionDto>"
             scope="request"/>
<jsp:useBean id="listaSalarioPorDepa" type="java.util.ArrayList<com.example.lab10_grupodinamin.Dtos.SalarioPorDepartamentoDto>"
             scope="request"/>
<!DOCTYPE html>
<html>
    <head>
